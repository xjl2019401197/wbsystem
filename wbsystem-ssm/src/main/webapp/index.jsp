            ...
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        <span><img alt="image" class="img-circle" src="./static/img/user.png"/></span>
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                               <span class="block m-t-xs">
                                   <strong class="font-bold">{{user.idCard}}</strong>
                               </span>
                                <span class="text-muted text-xs block">{{user.userType == 0? '管理员':user.userType == 1?'收银人员':'普通用户'}}<b
                                        class="caret"></b></span>
                                </span>
                        </a>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="userUpdate.jsp">信息修改</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="accountInfo.html">设备规格</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="consumerManager.html">消费信息</a>
                        </li>
                    </ul>
